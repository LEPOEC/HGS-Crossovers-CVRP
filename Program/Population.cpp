...
void Population::exportSearchProgress()
{
    ...
    std::ofstream MyFile("results/Instance_" + std::to_string(params.nbClients + 1) + "_" + params.ap.crossoverType + "_seed_" +  std::to_string(params.ap.seed) + ".txt");
